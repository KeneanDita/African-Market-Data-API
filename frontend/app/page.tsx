...
export default function Home() {
  return (
    <>
      {/* ---------------------------------------------------------------- hero */}
      <section className="mx-auto max-w-page px-6 pb-16 pt-20 md:pt-28">
        ...
        <div className="grid divide-y divide-line border-y border-line md:grid-cols-4 md:divide-x md:divide-y-0">
          {[
            ...
            <div key={label} className="py-8 md:px-8 md:first:pl-0 md:last:pr-0">
              <p className="num text-6xl md:text-7xl">{n}</p>
      ...
      <section className="mx-auto max-w-page px-6 pb-24">
        <div className="grid gap-12 lg:grid-cols-[5fr_7fr] lg:gap-20">
          ...
          <div className="card min-w-0 p-6 md:p-10">
      ...
      <section className="mx-auto max-w-page px-6 py-24">
        ...
        <ul className="mt-12 divide-y divide-line border-y border-line">
          {categories.map(([name, count, desc]) => (
            <li key={name} className="grid items-baseline gap-2 py-5 md:grid-cols-[14rem_4rem_1fr]">
